<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="身份" prop="shenfen">
          <el-input v-model="ruleForm.shenfen" 
              placeholder="身份" clearable  :readonly="ro.shenfen"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="转出时间" prop="zhuanchushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhuanchushijian" 
                type="datetime"
                :readonly="ro.zhuanchushijian"
                placeholder="转出时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuanchushijian" label="转出时间" prop="zhuanchushijian">
              <el-input v-model="ruleForm.zhuanchushijian" 
                placeholder="转出时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.zhuanchushijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weiyuanxingming = true;
          ...
          if(o=='zhuanchushijian'){
            this.ruleForm.zhuanchushijian = obj[o];
	    this.ro.zhuanchushijian = true;
            continue;
          }
          if(o=='crossuserid'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `lishidangyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.lishidangyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
