<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="应缴费金额" prop="yingjiaofeijine">
          <el-input v-model="ruleForm.yingjiaofeijine" 
              placeholder="应缴费金额" clearable  :readonly="ro.yingjiaofeijine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="应缴费金额" prop="yingjiaofeijine">
              <el-input v-model="ruleForm.yingjiaofeijine" 
                placeholder="应缴费金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	ispay : false,
      ...
      rules: {
          ...
          yingjiaofeijine: [
                { required: true, message: '应缴费金额不能为空', trigger: 'blur' },
          ],
          fabushijian: [
          ],
          ispay: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxifangshi = true;
          ...
          if(o=='yingjiaofeijine'){
            this.ruleForm.yingjiaofeijine = obj[o];
	    this.ro.yingjiaofeijine = true;
            continue;
          }
          if(o=='fabushijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dangfeijiaona/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dangfeijiaonaCrossAddOrUpdateFlag = false;
						 this.parent.search();
