<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告主题" prop="gonggaozhuti">
          <el-input v-model="ruleForm.gonggaozhuti" 
              placeholder="公告主题" clearable  :readonly="ro.gonggaozhuti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告主题" prop="gonggaozhuti">
              <el-input v-model="ruleForm.gonggaozhuti" 
                placeholder="公告主题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='gonggaozhuti'){
            this.ruleForm.gonggaozhuti = obj[o];
	    this.ro.gonggaozhuti = true;
            continue;
          }
          if(o=='fabushijian'){
